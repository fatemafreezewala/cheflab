...
//   const newPlus = (productId, index) => {
//     let a = [...restHomePageDataFoody];
//     a.map(item => {
//       let temp = Object.assign(item, {});
//       if (productId == temp?.product_id) {
//         console.log('new Plus add to cart 1 -> ', JSON.stringify(item));
//         temp.qty = temp.qty + 1;
//         console.log('new Plus add to cart 2 -> ', JSON.stringify(temp));
//       }
//       return temp;
//     });
//   };
...
//                     }
//                   } else {
//                     console.log('called ikfasjkldjas');
//                     onPlus('more', item?.product_id);
//                     addToCartRedux(item);
//                     restHomePageDataFoody[cartItemIndex].qty = optionListCount;
//                     setRestHomePageDataFoody(restHomePageDataFoody);
